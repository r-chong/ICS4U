...
// public class BuildingExpenseTester {
// public static void main(String[] args) {
// ArrayList<String> amenities = new ArrayList<String>(
// Arrays.asList("Gym", "Library", "Ergonomic chairs", "Chalkboard"));
// Building building1 = new Building("Llanford Building", 300, 3, amenities,
// 4000.0, true);

// // test case 1: creating building instance
// System.out.println("Test Case 1: create a building instance.");
// System.out.println(
// "Expected output: Building name: Llanford Building Capacity: 300 Levels: 3
// Amenities: [Gym, Library, Ergonomic Chairs, Chalkboard], Square Footage:
// 12000.0 Has wifi: true");
// System.out.println("");
...
// System.out.println("Expected output: Amenities: [Gym, Library, Ergonomic
// Chairs, Chalkboard, Swimming pool");
